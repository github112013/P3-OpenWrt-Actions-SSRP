# Actions-OpenWrt
## [![Build](https://img.shields.io/github/workflow/status/KleinerSource/P3-OpenWrt-Actions-SSRP/Build-OpenWrt/master?)](https://github.com/KleinerSource/P3-OpenWrt-Actions-SSRP/actions?query=workflow%3ABuild-OpenWrt)
